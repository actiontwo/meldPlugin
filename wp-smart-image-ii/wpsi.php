...
/*  Copyright 2009 - 2014 Darío Ferrer (wp@darioferrer.com)
...
foreach ($wpsi_vars_1 as $wpsiv1)
	$wpsi_configuracion[$wpsiv1] = $wpsi_modo_php == 1 ? $wpsi_php[$wpsiv1] : (isset($_POST[$wpsiv1]) ? wp_filter_kses($_POST[$wpsiv1]) : $wpsi_config[$wpsiv1]);
